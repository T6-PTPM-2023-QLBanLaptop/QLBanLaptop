...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2023 at 04:59 PM
...
CREATE TABLE `ordered` (
  ...
  `extra_address` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;
...
CREATE TABLE `product` (
  ...
  `short_desc` varchar(300) NOT NULL COMMENT 'vd : LÀM VIỆC HIỆU QUẢ, GIẢI TRÍ THẢ GA',
...
CREATE TABLE `user` (
  ...
  `username` varchar(30) NOT NULL,
  `password` varchar(200) NOT NULL,
  `address` varchar(300) DEFAULT 'unknow',
  `city` varchar(300) DEFAULT 'unknow',
  `dob` varchar(300) DEFAULT '2020-04-25',
  `phone` varchar(300) DEFAULT 'unknow',
  `full_name` varchar(300) DEFAULT 'unknow',
  `email` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;
...
(14, 'nhatduydc', '202cb962ac59075b964b07152d234b70', 'HCM', 'HCM', '2002-05-07', '0393246372', 'duy', 'nhatduydc@gmail.com');
